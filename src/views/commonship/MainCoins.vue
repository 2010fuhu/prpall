     ...
     <div  class="dialog"  v-show="isCoinschildShow" >
         <div class="content"  ref="Coins">
            ...
            <table ref="coinsData" class="common" cellpadding="3" cellspacing="0" >
              ...
              <tr v-for="(coinsInfoVo, index) in coinsInfoVoList" :key="index">
                <td>
                  ...
                  <input type="text" name="SerialNoCoins" class="readonly3" readonly style="width:100%" description="联/共保主信息序号"  v-model='coinsInfoVo.serialNo'>
                </td>
            ...
            <table ref="coinsMiddle" class="common" cellpadding="5" cellspacing="1" border="0">
              <tr >
                <td align="center" width="50%">
                  ...
                  <input type="radio" name="proportionFlag1" value="0" v-model="proportionFlag1" @change="setRefreshFlagDetailZero()">份额计入
                  <input type="radio" name="proportionFlag1" value="1" :disabled="billTypeDisabled" v-model="proportionFlag1"  @change="setRefreshFlagDetailZero()">全额计入 
                </td>
                <td align="center" width="50%" style="display:">
                  <input type="hidden" name="BillTypeValue" value="1" description="开具发票方式">开具发票方式：
                  <input type="radio" name="billType" value="0" checked  v-model="billType" @change="setRefreshFlagDetailZero()">全额发票
                  <input type="radio" name="billType" value="1"  :disabled="billTypeDisabled"  v-model="billType" @change="setRefreshFlagDetailZero()">份额发票 
                </td>  
            ...
            <table id="CoinsDetail" class="list" v-show="CoinsDetailShow" cellpadding="3" cellspacing="0" >
              ...
              <tbody>
                ...
                <td>
                  ...
                  <input type="text" name="SerialNoDetail" class="readonly3" readonly style="width:100%" description="联/共保明细信息序号" :value="coinsDetailInfoVo.serialNo">
                </td>
                <td>
                  <input type="text" name="coinsName" class="readonly3" readonly style="width:100%" description="联/共保人名称"  :value="coinsDetailInfoVo.coinsName">
                </td>
                <td>
                  <input type="text" name="currency" class="readonly3" readonly style="width:30%" description="币别代码" :value="coinsDetailInfoVo.currency">
                  <input type="text" name="CurrencyName" class="readonly3" readonly style="width:60%" description="币别名称" :value="CurrencyName">
                </td>
                <td>
                  <input type="text" name="coinsAmount" ref="coinsAmount"  class="common3" style="width:50%"  description="联/共保各方保额" v-model="coinsDetailInfoVo.coinsAmount"
                    @keypress="pressDecimal($event)"
                    @blur="$uiCommon.checkDecimal($event,14,2,'','');changeAmount();">
                  <span id="spanChgCoinsAmount" v-show="$route.path=='/pgMain'">
                    <br><input type="text" name="chgCoinsAmount" ref='chgCoinsAmount' class="readonly3" readonly style="width:45%" description="保额变化量" value=0.00  >
                  </span>
                </td>
                <td>
                  <input type="text" name="coinsPremium" ref="coinsPremium" class="readonly3" readonly style="width:50%" description="联/共保各方保费" :value="coinsDetailInfoVo.coinsPremium">
                  <span id="spanChgCoinsPremium" v-show="$route.path=='/pgMain'">
                    <br><input type="text" name="chgCoinsPremium"  ref='chgCoinsPremium'  class="readonly3" readonly style="width:45%" description="保费变化量" value=0.00 >
                  </span>
                </td>
                <td>
                  <input type="text" name="agentFee" ref="agentFee" class="readonly3"  readonly style="width:50%" description="联/共保各方手续费/经纪费"   :value="coinsDetailInfoVo.agentFee">
                  <span id="spanChgAgentFee" v-show="$route.path=='/pgMain'">
                    <br><input type="text" name="chgAgentFee"  ref='chgAgentFee'  class="readonly3" readonly style="width:45%" description="联/共保各方手续费/经纪费变化量" value=0.00>
                  </span>
                </td>
                <td style="display:none">
                  <input type="text" name="middleCostFee" class="readonly3"  readonly style="width:50%" description="联/共保各方特殊因子费"   :value="coinsDetailInfoVo.middleCostFee">
                  <span id="spanChgMiddleCostFee" v-show="$route.path=='/pgMain'">
                    <br><input type="text" name="chgMiddleCostFee" ref='chgMiddleCostFee'  class="readonly3" readonly style="width:45%" description="联/共保各方特殊因子费变化量" value=0.00>
                  </span>
                </td>
                <td>
                  <span id="spanOperateFee">
                    <input type="text" name="operateFee" class="readonly3"  style="width:50%"  description="联/共保各方出单费"  readonly  ref="operateFee"  @change="calOperateFeesum" v-model="coinsDetailInfoVo.operateFee">
                  </span>
                  <span id="spanChgOperateFee" v-show="$route.path=='/pgMain'">
                    <br><input type="text" name="chgOperateFee"  ref='chgMiddleCostFee' class="readonly3" readonly style="width:45%" description="联/共保各方出单费变化量" value=0.00> 
                  </span>
                </td>
              </tr>
              </tbody>
            ...
            <table id="Coinssum" class="list"   v-show="CoinssumShow" cellpadding="3" cellspacing="0" >
              ...
              <tr>
                <td>
                  ...
                  <input type="text" name="SerialNoDetailsum" class="readonly3" readonly style="width:100%" value="     " description="联/共保明细信息序号"> -->
                </td>
                <td>
                  <!-- <input type="text" name="CoinsNameDetailsum" class="readonly3" readonly  style="width:100%" value="    " description="联/共保人名称"> -->
                </td>
                <td>
                  <!-- <input type="text" name="CurrencyDetailsum"  class="readonly3" readonly style="width:30%" value="    " description="币别代码">
                  <input type="text" name="CurrencyNameDetailsum" class="readonly3" readonly  style="width:60%"  value="   " description="币别名称"> -->
                </td>
                <td >
                  <input type="text" name="CoinsAmountsum" class="common3" style="width:50%"  :readonly="$route.path=='/pgMain'" description="联/共保合计保额"  :value="CoinsAmountsum">
                  <span  v-if="$route.path=='/pgMain'">
                    <br><input type="text" name="ChgCoinsAmountsum" class="readonly3" readonly style="width:45%" description="保额变化量"
                ...
                <td>
                  ...
                  <span  v-if="$route.path=='/pgMain'" >
                    <br><input type="text" name="ChgCoinsPremiumsum" class="readonly3" readonly style="width:45%" description="合计保费变化量"
                    :value="chgCoinsPremiumSum">
                  </span>
                </td>
                <td>
                  <input type="text" name="AgentFeesum" class="common3"  style="width:50%"  :readonly="$route.path=='/pgMain'" description="联/共保合计手续费/经纪费"   :value="AgentFeesum" >
                  <span  v-if="$route.path=='/pgMain'">
                    <br><input type="text" name="ChgAgentFeesum" class="readonly3" readonly style="width:45%" description="联/共保合计手续费/经纪费变化量"
                    :value="chgAgentFeeSum">
                  </span>
                </td>
                <td style="display:none">
                  <input type="text" name="MiddleCostFeesum" class="readonly3" readonly style="width:50%" description="联/共保合计特殊因子费"  :value='MiddleCostFeesum'>
                  <span  v-if="$route.path=='/pgMain'">
                    <br><input type="text" name="ChgMiddleCostFeesum" class="readonly3" readonly style="width:45%" description="联/共保合计特殊因子费变化量"
                    :value="chgMiddleCostFeeSum">
                  </span>
                </td>
                <td>
                  <span id="spanOperateFeesum">
                    <input type="text" name="OperateFeesum" class="common3" style="width:50%"   :readonly="$route.path=='/pgMain'"   description="联/共保合计出单费"    :value='OperateFeesum'>
                  </span>
                  <span  v-if="$route.path=='/pgMain'">
                    <br><input type="text" name="chgOperateFeeSum" class="readonly3" readonly style="width:45%" description="联/共保各合计出单费变化量"
            ...
            <table class="common" border="0">
                    <tr>
                      <td width="34%"  v-if="$route.path!='/proposalShow'&&$route.path!='/policyShow'">
                      ...
                      <td width="33%"  v-if="$route.path!='/proposalShow'&&$route.path!='/policyShow'" >
